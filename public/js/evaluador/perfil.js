...
$(document).ready(function () {
  ...
  $('#to_page_14').click(function () {
    ...
    if (horizonte_temporal < 3) {
      ...
      $('#page_14 .horizonte img:first-child').attr('src', "https://z-eval.s3.amazonaws.com/inv/".concat(gender, "_conservador_on.png"));
      $('#page_14 .horizonte img:nth-child(2)').attr('src', "https://z-eval.s3.amazonaws.com/inv/".concat(gender, "_moderado_off.png"));
      $('#page_14 .horizonte img:nth-child(3)').attr('src', "https://z-eval.s3.amazonaws.com/inv/".concat(gender, "_arriesgado_off.png"));
