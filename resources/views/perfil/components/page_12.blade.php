<!-- <section id="page_12" class="page-content animate__animated animate__fadeIn"> -->
<section id="page_12" class="page-content animate__animated animate__fadeIn d-none ">
    <div class='d-flex justify-content-between align-items-center mb-4'>
        <p class='prev_link mt-2 mb-1' id='prev_page_11'>
    ...
    <div class='card mt-2 p-3'>
        ...
        <button class='continue_btn mx-auto mb-4' id='to_page_13'>Continuar</button>
    </div>
</section>