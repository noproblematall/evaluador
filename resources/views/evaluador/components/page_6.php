<section id="page_6" class="page-content animate__animated animate__fadeIn d-none">
    ...
    <div class="card mx-0 px-1 pb-4">
        ...
        <div class='inner'>
            <div class='console-small-container'>
                <div class='title-container'>
                    <p class='title'>¿Qué te gustaría planificar?</p>
                </div>
                ...
                <div class='image-container'>
                    ...
                    <img class='plan-3' src='https://z-eval.s3.amazonaws.com/misc/think_coin.png' alt='Coin' />
        ...
        <button class='continue_btn mx-auto' id='to_page_7'>Continuar</button>
    </div>
</section>