...
<section id="page_5" class="page-content animate__animated animate__fadeIn d-none">
    ...
    <div class='d-flex  align-items-center'>
        ...
        <p class='color-blue px-2 title'>Qué te gustaría planificar para tu futuro?</p>
    </div>
    <div class='card mt-2 px-3 pb-3'>
        <div class='plan-image-container'>
            <div class='image-container'>
                ...
                <img class='plan-0' src='https://z-eval.s3.amazonaws.com/misc/think_money.png' alt='money' />
                <img class='plan-1' src='https://z-eval.s3.amazonaws.com/misc/think_edu.png' alt='Education' />
                <img class='plan-2' src='https://z-eval.s3.amazonaws.com/misc/think_coin.png' alt='Coin' />
                <img class='plan-3' src='https://z-eval.s3.amazonaws.com/misc/think_work.png' alt='Coin' />
                <img class='plan-4' src='https://z-eval.s3.amazonaws.com/misc/think_health.png' alt='Health' />
            </div>
        </div>
        <hr />
        <div class='items-container mt-2 row'>
            <p class='plan-description text-center my-1'>Quiero planificar para mi futuro…</p>
        ...
        <button class='continue_btn mx-auto mb-4' id='to_page_6'>Continuar</button>
    </div>
</section>