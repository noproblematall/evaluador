$(document).ready(function () {
    ...
    var first_card_images = [
        'https://z-eval.s3.amazonaws.com/cards/Arriesgado.png',
        'https://z-eval.s3.amazonaws.com/cards/Algo+arriesgado.png',
        'https://z-eval.s3.amazonaws.com/cards/Moderado.png',
        'https://z-eval.s3.amazonaws.com/cards/Algo+conservador.png',
        'https://z-eval.s3.amazonaws.com/cards/Conservador.png'
    ];
    var second_card_images = [
        'https://z-eval.s3.amazonaws.com/cards/Corto+plazo.png',
        'https://z-eval.s3.amazonaws.com/cards/Mediano+plazo.png',
        'https://z-eval.s3.amazonaws.com/cards/Largo+plazo.png'
    ]
